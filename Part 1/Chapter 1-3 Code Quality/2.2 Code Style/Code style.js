...
// function pow(x,n) 
// {
//   let result=1;  нехватает пробелов 
//   for(let i=0;i<n;i++) {result*=x;}        нехватает пробелов внутри условия цикла и нет перноса на другую строку после фигурной скобки 
//   return result;
// }

// let x=prompt("x?",''), n=prompt("n?",'')      нехватает пробелов 
// if (n<=0)  нехватает пробелов 
// {
//   alert(`Степень ${n} не поддерживается, введите целую степень, большую 0`);
// }
// else
// {
//   alert(pow(x,n))       нехватает пробелов 
// }
